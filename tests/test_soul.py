...
for w in ("يستدعي", "يُكرّس", "يُمكّن", "تمكين"):
    ok(f"  ⟵ {w}", w in TXT)
# الشرطةُ الطويلة: قاعدةٌ تطابق ما يفعله text_cleaner، فلا يتقاتلان.
ok("والشرطةُ الطويلةُ ممنوعةٌ في النثر", "شرطةَ طويلة" in TXT)
ok("  ⟵ وبديلُها القصيرةُ كما يفعل text_cleaner",
   "شرطةٌ قصيرة (-)" in TXT)
