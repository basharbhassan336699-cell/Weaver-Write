...
_SKILL_PROBES["academic-humanize"] = (
    "هذه فقرةٌ من فصلٍ في بحثٍ جامعيّ كتبها زميلي بمساعدة برنامج ذكاءٍ اصطناعيّ. "
    "أريدها أقربَ إلى كتابة باحثٍ حقيقيّ، بنبرةٍ علميّةٍ رسميّة:\n\n"
    "يُعدّ التعليمُ الإلكترونيُّ ركيزةً أساسيّةً في المنظومة التعليميّة الحديثة "
    "(الفهري، 2020، ص. 45). وعلاوة على ذلك، فقد أسهم في رفع نسبة الالتحاق "
    "بالجامعات بنحو 30% خلال العقد الأخير (Smith et al., 2019, p. 12). "
    "وتجدر الإشارة إلى أنّ هذا التحوّلَ يستدعي تضافرَ الجهود لضمان الجودة. "
    "وفي الختام، يتضح أنّ التعليمَ الإلكترونيَّ هو السبيلُ الأمثلُ لمستقبلٍ أفضل.")
_SKILL_PROBES["voice-inject"] = (
    "هذه تدوينةٌ كتبتُها لمدوّنتي، لكنّها جافّةٌ بلا روح. أضف إليها صوتي. "
    "ورأيي أنّ التعليمَ عن بُعد أنصف الطالبات أكثرَ من غيرهنّ:\n\n"
    "انتقلت الجامعاتُ خلال السنوات الأخيرة إلى المنصّات الرقميّة. وأصبح الطالبُ "
